...
public partial class DistanceUniversities : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ltl_bredcrumbs.Text = "<a href='https://www.eduvidya.com/'>Home</a>Universities in India";
    ...
    protected void fn_BindUniversity()
    {
        try
        {
            ...
            CoreWebList<DistanceLearningClass> objUniversityList = objUniversity.fn_GetDistanceLearningList();
