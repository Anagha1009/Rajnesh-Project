...
public partial class Schools : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ltl_bredcrumbs.Text = "<a href='https://www.eduvidya.com/'>Home</a>Schools in India";

            HtmlControl dynamicid = (HtmlControl)Master.FindControl("dynamicid");
            dynamicid.ID = "schools-in-india-page";
        }
    }
    ...
    protected void fn_BindSchools()
    {
        try
        {
            ...
            CoreWebList<SchoolClass> objSchoolList = objSchool.fn_getSchoolList();
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            if (ddl_Category.SelectedValue != "0" || ddl_City.SelectedValue != "0")
            {
                ...
                string strUrl = "School-Search.aspx?";
