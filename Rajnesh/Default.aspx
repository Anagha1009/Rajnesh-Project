...
<body>
    ...
    <link rel="dns-prefetch" href="//fonts.googleapis.com"> <script>
                                                                WebFontConfig = {
                                                                    google: { families:
['Ubuntu:300,400,500,700,300italic,400italic,500italic,700italic', 'Open+Sans', 'Joti+One']
                                                                    },
                                                                    active: function() {
                                                                    } 
                                                                };
                                                                var el = document.getElementsByClassName("logo"); for (var i = 0; i < el.length; i++)
                                                                    el[i].style.fontFamily = "Ubuntu";
                                                                var el = document.getElementsByClassName("heading"); for (var i = 0; i < el.length; i++)
                                                                    el[i].style.fontFamily = "Ubuntu";
                                                                var el = document.getElementsByClassName("cssmenu"); for (var i = 0; i < el.length; i++)
                                                                    el[i].style.fontFamily = "Ubuntu";
</script>
