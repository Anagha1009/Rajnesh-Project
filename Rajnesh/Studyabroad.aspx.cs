...
public partial class Search_list : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ltl_bredcrumbs.Text = "<a href='https://www.eduvidya.com/'>Home</a>Studyabroad";

            HtmlControl dynamicid = (HtmlControl)Master.FindControl("dynamicid");
            dynamicid.ID = "studyabroad";

        }
    }

    protected void fn_BindCountry()
    {
        try
        {
            ...
            if (objStudyList.Count > 0)
            {
                ...
                DataView dv = new DataView((DataTable)objStudyList);
    ...
    protected void fn_BindCountryWithoutPagging()
    {
        try
        {
            CountryClass objStudy = new CountryClass();
