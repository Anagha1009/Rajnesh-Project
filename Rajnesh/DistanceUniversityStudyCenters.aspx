<%@ Page Language="C#" MasterPageFile="~/ClientMaster.master" AutoEventWireup="true"
    CodeFile="DistanceUniversityStudyCenters.aspx.cs" Inherits="CollegeStudyCenters" %>
        ...
        <div class="box-content">
            ...
            <div class="filter-result">
                ...
                <div class="detail-list">
                    <ul>
                        <asp:Repeater ID="rpt_StudyCenters" runat="server">
                            <ItemTemplate>
                                <li>
                                    <b><%# Eval("strStudyCenterTitle")%></b>
                                    <br />
                                    <%# Eval("strStudyCenterDesc")%>
                                    <br />
                                    <%# "<b>Address : </b>" + Eval("strStudyCenterAddrs")%>
                                </li>
