<%@ Page Title="" Language="C#" MasterPageFile="~/ClientDetailsMaster.master" AutoEventWireup="true"
    CodeFile="UniversityDetails.aspx.cs" Inherits="University_Details" %>
            ...
            <div class="details-page-tab">
                ...
                <div class="tab-section-inner-wrapper">
                    ...
                    <div id="courses" class="tab-content-inner">
                        ...
                        <p>Courses:</p>
                        <p>
                            <a href='<%= VirtualPathUtility.ToAbsolute("~/University/" + RouteData.Values["University"].ToString().Replace(" ","-").Replace(".","_") + "/Courses")%>'>
                        ...
                        <ul>
                            <asp:Repeater ID="rpt_Courses" runat="server">
                                <ItemTemplate>
                                    <li><a href='<%# VirtualPathUtility.ToAbsolute("~/University/" + Eval("strInstitute").ToString().Replace(" ","-").Replace(".","_") + "/Courses/" + Eval("strCourseName").ToString().Replace(" ","-").Replace(".","_"))%>'>
