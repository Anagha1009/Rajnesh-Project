...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Study Abroad|Top Universities in the World 2016|</title>
    <meta name="Description" content="List of top universities in the World 2016, Study abroad scholarships and programs" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="cp_left" runat="Server">
    <div class="box">
        ...
        <div class="box-content">
            ...
            <div class="list">
                <p>
                    Given below is the list of top universities in the world 2016 for studying abroad in different countries. Going to a foreign land for higher studies is a dream for many. The lure of top paycheck, comfortable life is too hard to resist. Adding to this lure are the various countries that offer attractive programs to international students including study abroad scholarships. 
                </p>
                <br />
                <p>
