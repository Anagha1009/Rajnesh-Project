...
public partial class CollegeCourses : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ltl_bredcrumbs.Text = "<a href='https://www.eduvidya.com/'>Home</a>Courses in India";

            HtmlControl dynamicid = (HtmlControl)Master.FindControl("dynamicid");
            dynamicid.ID = "courses-in-india-page";
        }
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            if (ddl_Category.SelectedValue != "0")
            {
                ...
                string strUrl = "Course-Search.aspx?Category=" + strCategory.Replace(" ", "-") + "&CategoryID=" + iCategoryID;
