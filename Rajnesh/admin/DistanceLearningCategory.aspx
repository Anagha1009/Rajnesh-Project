<%@ Page Title="Admin :: Distance Learning Category" Language="C#" MasterPageFile="~/admin/Master.master" AutoEventWireup="true" CodeFile="DistanceLearningCategory.aspx.cs" Inherits="admin_DistanceLearningCategory" %>
...
<table width="80%" align="center">   
    <tr>
        ...
        <asp:Label ID="Label1" ForeColor="#ff6633" runat="server" Font-Bold="true" Text="Distance Learning Title: "></asp:Label>
