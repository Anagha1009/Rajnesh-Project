...
public partial class admin_UniversityVideo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            BredCrumbs.InnerHtml = "<a class='link' href='" + VirtualPathUtility.ToAbsolute("~/admin/") + "'>Home</a> &nbsp; > &nbsp; &nbsp;UniversityVideo";
    ...
    protected void fn_BindRecords()
    {
        try
        {
            UniversityVideoClass objUniversityVideo = new UniversityVideoClass();
			objUniversityVideo.iUniversityID = iUniversityID;
			CoreWebList<UniversityVideoClass> objUniversityVideoList = objUniversityVideo.fn_getUniversityVideoByUniversityID();
			if (objUniversityVideoList.Count > 0)
			{
				ViewState["dtRecords"] = (DataTable)objUniversityVideoList;
				grd_Records.DataSource = objUniversityVideoList;
			}
			else
			{
    ...
    protected void fn_BindDetails(int iRecordID)
    {
        ...
        {
            UniversityVideoClass objUniversityVideo = new UniversityVideoClass();
			objUniversityVideo.iID = iRecordID;
			CoreWebList<UniversityVideoClass> objUniversityVideoList = objUniversityVideo.fn_getUniversityVideoByID();
			if (objUniversityVideoList.Count > 0)
			{
				dv_Records.DataSource = objUniversityVideoList;
				dv_Records.DataBind();
			}
        }
        catch (Exception ex)
    ...
    protected void grd_Records_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        {
            UniversityVideoClass objUniversityVideo = new UniversityVideoClass();
			objUniversityVideo.iID = int.Parse(grd_Records.DataKeys[e.RowIndex].Value.ToString());

			string strResponse = objUniversityVideo.fn_deleteUniversityVideo();
    ...
    protected void dv_Records_ItemInserting(object sender, DetailsViewInsertEventArgs e)
    {
        try
        {
			...
			UniversityVideoClass objUniversityVideo = new UniversityVideoClass();
			objUniversityVideo.iUniversityID = iUniversityID;
			objUniversityVideo.strTitle = txtTitle.Text;
			objUniversityVideo.strUrl = txtUrl.Text;

			string strResponse = objUniversityVideo.fn_saveUniversityVideo();
    ...
    protected void dv_Records_ItemUpdating(object sender, DetailsViewUpdateEventArgs e)
    {
        try
        {
			...
			UniversityVideoClass objUniversityVideo = new UniversityVideoClass();
			objUniversityVideo.iID = int.Parse(dv_Records.DataKey.Value.ToString());
			objUniversityVideo.strTitle = txtTitle.Text;
			objUniversityVideo.strUrl = txtUrl.Text;

			string strResponse = objUniversityVideo.fn_editUniversityVideo();
    ...
    protected void btnSearch_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            UniversityVideoClass objUniversityVideo = new UniversityVideoClass();
			objUniversityVideo.strTitle = txtSearch.Text.Trim();
			CoreWebList<UniversityVideoClass> objUniversityVideoList = objUniversityVideo.fn_getUniversityVideoByKeys();
			if (objUniversityVideoList.Count > 0)
			{
				ViewState["dtRecords"] = (DataTable)objUniversityVideoList;
				grd_Records.DataSource = objUniversityVideoList;
