<%@ Page Title="Control Panel | VoteDetail" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="Options.aspx.cs" Inherits="admin_VoteDetail"
                ...
                <asp:GridView ID="grd_Records" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Photo">
                            ...
                            <ItemTemplate>
                                <img src='<%# "../files/Options/" + Eval("strPhoto") %>' alt="" class="photo" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:BoundField DataField="iRate" HeaderText="Vote Counts" SortExpression="iRate">
                            <ItemStyle HorizontalAlign="center" />
                        </asp:BoundField>
                                            ...
                                            <table width="100%" cellpadding="0px" cellspacing="0px" border="0px">
                                                <tr>
                                                    <td align="left" valign="top" class="_photo_box">
                                                        <img src='<%# VirtualPathUtility.ToAbsolute("~/files/Options/" + Eval("strPhoto"))%>'
                                                            alt="" />
                                                    </td>
                                                </tr>
                                                <tr>
