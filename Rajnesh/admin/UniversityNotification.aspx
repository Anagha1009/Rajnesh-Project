<%@ Page Title="Control Panel | Notification" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="UniversityNotification.aspx.cs" Inherits="admin_Notification"
                            ...
                            <InsertItemTemplate>
                                <table width="100%" cellpadding="3px" cellspacing="3px" border="0px">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtDesc" runat="server" TextMode="MultiLine" CssClass="ckeditor"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </InsertItemTemplate>
                            <EditItemTemplate>
                                <table width="100%" cellpadding="3px" cellspacing="3px" border="0px">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtDesc" runat="server" TextMode="MultiLine" CssClass="ckeditor"
