<%@ Page Title="Admin :: Control Panel" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="InstitutePhotos.aspx.cs" Inherits="admin_Photos" MaintainScrollPositionOnPostback="true"
...
<asp:Content ID="Content1" ContentPlaceHolderID="AdminContentPlaceHolder" runat="Server">
                ...
                <asp:GridView ID="grd_Photos" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Image">
                            ...
                            <ItemTemplate>
                                <img src='<%# "Upload/Institutes/" + Eval("strPhoto") %>' title="" class="photo" />
                            </ItemTemplate>
                        </asp:TemplateField>
    ...
    <table width="95%" align="center">
        <tr>
            <td class="_heading">
                <asp:Label ID="Label1" CssClass="font_title_text" runat="server" Text="Institute Photos Details"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
