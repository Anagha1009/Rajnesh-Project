...
public partial class admin_DistanceLearning_university : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                string strQuery = "SELECT * FROM edu_distancelearning WHERE distancelearning_type='University' ORDER BY distancelearning_name ASC";
    ...
    protected void dv_DLearning_ItemInserting(object sender, DetailsViewInsertEventArgs e)
    {
        try
        {
            ...
            FCKeditor FCKExams = (FCKeditor)dv_DLearning.FindControl("FCKExams");
            FCKeditor FCKAdmissions = (FCKeditor)dv_DLearning.FindControl("FCKAdmissions");
            FCKeditor FCKResults = (FCKeditor)dv_DLearning.FindControl("FCKResults");
            ...
            objCM.strDesc = FCKDesc.Value;
            objCM.strExamDetails = FCKExams.Value;
            objCM.strAdmissions = FCKAdmissions.Value;
            objCM.strResults = FCKResults.Value;
            ...
            FCKExams.Value = string.Empty;
            FCKAdmissions.Value = string.Empty;
            FCKResults.Value = string.Empty;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        strQuery += " WHERE distancelearning_type='University' AND distancelearning_name LIKE '%" + txtInstituteTitle.Text.ToString().Trim() + "%' ";
