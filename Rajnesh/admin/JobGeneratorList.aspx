<%@ Page Title="Admin :: Job Generator List" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="JobGeneratorList.aspx.cs" Inherits="admin_Articles" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="AdminContentPlaceHolder" runat="Server">
    ...
    <table width="90%" border="0" align="center">
        <tr>
            <td align="left">
                <asp:Label ID="Label3" CssClass="font_title_text" runat="server" Text="J O B&nbsp;&nbsp;&nbsp;&nbsp;L I S T"></asp:Label>
                <br />
                <hr />
            </td>
        </tr>
        ...
        <tr>
            <td>
                <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" Text="Post New Job" />
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td align="center">
                <asp:GridView ID="grd_Query" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    OnRowDeleting="grd_Query_RowDeleting" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="View" ItemStyle-Width="10%">
                            <ItemTemplate>
                                <a href='<%# System.Web.Routing.RouteTable.Routes.GetVirtualPath(null, "JobGenaratorList", new System.Web.Routing.RouteValueDictionary { { "Job", Eval("strFileName") } }).VirtualPath%>' target="_blank">
                                    View</a>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Edit" ItemStyle-Width="10%">
                            <ItemTemplate>
                                <a href='<%# "JobGenerator.aspx?Mode=Update&JobId=" + Eval("iID")  %>'>
