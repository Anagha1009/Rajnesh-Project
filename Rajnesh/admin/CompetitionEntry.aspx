<%@ Page Title="Control Panel | CompetitionEntry" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="CompetitionEntry.aspx.cs" Inherits="admin_CompetitionEntry"
        ...
        <tr>
            <td align="left">
                <asp:GridView ID="grd_Records" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    OnSelectedIndexChanged="grd_Records_SelectedIndexChanged" PageSize="25" OnRowDataBound="grd_Records_RowDataBound">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Results">
                            <ItemTemplate>
                                <img id="img_Result" runat="server" />
                                <asp:HiddenField runat="server" ID="hfUserID" Value='<%# Eval("iID") %>' />
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" Width="5%" />
                        </asp:TemplateField>
