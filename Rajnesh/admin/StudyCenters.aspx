<%@ Page Title="Admin :: StudyCenters" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="StudyCenters.aspx.cs" Inherits="admin_StudyCenters" MaintainScrollPositionOnPostback="true"
...
<asp:Content ID="Content1" ContentPlaceHolderID="AdminContentPlaceHolder" runat="Server">
    ...
    <table width="95%" border="0" align="center">
        ...
        <tr>
            <td align="center" colspan="3">
                <asp:GridView ID="grd_StudyCenters" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    OnRowDeleting="grd_StudyCenters_RowDeleting" OnSelectedIndexChanged="grd_StudyCenters_SelectedIndexChanged"
                    OnSorting="grd_StudyCenters_Sorting" OnPageIndexChanging="grd_StudyCenters_PageIndexChanging"
                    PageSize="10">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="strStudyCenterTitle" HeaderText="Study Center" SortExpression="strStudyCenterTitle">
    ...
    <table width="95%" align="center">
        <tr>
            <td class="_heading">
                <asp:Label ID="Label1" CssClass="font_title_text" runat="server" Text="StudyCenters Details"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <br />
                <asp:DetailsView ID="dv_StudyCenters" runat="server" AutoGenerateRows="False" DataKeyNames="iID"
                    Width="95%" GridLines="None" CellPadding="3" CellSpacing="3" OnItemInserting="dv_StudyCenters_ItemInserting"
                    OnItemUpdating="dv_StudyCenters_ItemUpdating" OnModeChanging="dv_StudyCenters_ModeChanging">
                    <Fields>
                        <asp:BoundField DataField="iID" HeaderText="ID" Visible="False" ReadOnly="True" />
                        
                        <asp:TemplateField HeaderText="Title">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtTitle" runat="server" Text='<%# Eval("strStudyCenterTitle") %>' CssClass="txtBox">
                                </asp:TextBox>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblTitle" runat="server" Text='<%# Eval("strStudyCenterTitle") %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Description" HeaderStyle-VerticalAlign="Top">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtDescription" runat="server" CssClass="ckeditor" TextMode="MultiLine"
                                    Text='<%# Eval("strStudyCenterDesc") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <InsertItemTemplate>
                                <asp:TextBox ID="txtDescription" runat="server" CssClass="ckeditor" TextMode="MultiLine"
                                    Text='<%# Eval("strStudyCenterDesc") %>'></asp:TextBox>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblDesc" runat="server" Text='<%# Eval("strStudyCenterDesc") %>'></asp:Label>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Address" HeaderStyle-VerticalAlign="Top">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtAddress" runat="server" CssClass="txtArea" TextMode="MultiLine"
                                    Text='<%# Eval("strStudyCenterAddrs") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <InsertItemTemplate>
                                <asp:TextBox ID="txtAddress" runat="server" CssClass="txtArea" TextMode="MultiLine"
                                    Text='<%# Eval("strStudyCenterAddrs") %>'></asp:TextBox>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblAddress" runat="server" Text='<%# Eval("strStudyCenterAddrs") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle VerticalAlign="Top"></HeaderStyle>
                        </asp:TemplateField>
