<%@ Page Title="Admin :: Category Links" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="CategoryLinks.aspx.cs" Inherits="admin_CategoryLinks"
...
<asp:Content ID="Content1" ContentPlaceHolderID="AdminContentPlaceHolder" runat="Server">
    ...
    <table width="95%" border="0" align="center">
        ...
        <tr>
            <td align="center" colspan="3">
                <asp:GridView ID="grd_CategoryLinks" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    OnRowDeleting="grd_CategoryLinks_RowDeleting" OnSelectedIndexChanged="grd_CategoryLinks_SelectedIndexChanged"
                    OnSorting="grd_CategoryLinks_Sorting" OnPageIndexChanging="grd_CategoryLinks_PageIndexChanging"
                    PageSize="10">
    ...
    <table width="95%" align="center">
        <tr>
            <td class="_heading">
                <asp:Label ID="Label1" CssClass="font_title_text" runat="server" Text="Category Links Details"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="left">
                ...
                <br />
                <asp:DetailsView ID="dv_CategoryLinks" runat="server" AutoGenerateRows="False" DataKeyNames="iID"
                    Width="95%" GridLines="None" CellPadding="3" CellSpacing="3" OnItemInserting="dv_CategoryLinks_ItemInserting"
                    OnItemUpdating="dv_CategoryLinks_ItemUpdating" OnModeChanging="dv_CategoryLinks_ModeChanging">
                    <Fields>
