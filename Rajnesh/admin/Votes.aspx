<%@ Page Title="Control Panel | Vote" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="Votes.aspx.cs" Inherits="admin_Vote" MaintainScrollPositionOnPostback="true"
                ...
                <asp:GridView ID="grd_Records" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Icon">
                            ...
                            <ItemTemplate>
                                <img src='<%# "../files/Votes/" + Eval("strIcon") %>' alt="" class="photo" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="strTitle" HeaderText="Title" SortExpression="strTitle">
                            <ItemStyle HorizontalAlign="center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="iVoteCounts" HeaderText="Vote Counts" SortExpression="iVoteCounts">
                            <ItemStyle HorizontalAlign="center" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="Options">
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                            <ItemTemplate>
                                <a href='<%# "Options.aspx?VoteID=" + Eval("iID") %>'>
                            ...
                            <EditItemTemplate>
                                <table width="100%" cellpadding="3px" cellspacing="3px" border="0px">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtUrl" runat="server" CssClass="txtbox" Text='<%# Eval("strUrl") %>'></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table width="100%" cellpadding="0px" cellspacing="0px" border="0px">
                                                <tr>
                                                    <td align="left" valign="top" class="_photo_box">
                                                        <img src='<%# VirtualPathUtility.ToAbsolute("~/files/Votes/" + Eval("strIcon"))%>'
                                                            alt="" />
                                                    </td>
                                                </tr>
                                                <tr>
