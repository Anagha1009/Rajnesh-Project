<%@ Page Title="Control Panel | Country" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="Country.aspx.cs" Inherits="admin_Country" MaintainScrollPositionOnPostback="true"
                ...
                <asp:GridView ID="grd_Records" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Photo">
                            ...
                            <ItemTemplate>
                                <img src='<%# "../files/Country/" + Eval("strPhoto") %>' alt="" class="photo" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Article">
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                            <ItemTemplate>
                                <a href='<%# "Article.aspx?CountryID=" + Eval("iID") %>'>
                        ...
                        <asp:TemplateField HeaderText="University">
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                            <ItemTemplate>
                                <a href='<%# "University.aspx?CountryID=" + Eval("iID") %>'>
                                    <img src="images/add.png" alt="" class="Icons" /></a>
                            </ItemTemplate>
                        </asp:TemplateField>
                                            ...
                                            <table width="100%" cellpadding="0px" cellspacing="0px" border="0px">
                                                <tr>
                                                    <td align="left" valign="top" class="_photo_box">
                                                        <img src='<%# VirtualPathUtility.ToAbsolute("~/files/Country/" + Eval("strPhoto"))%>'
                                                            alt="" />
                                                    </td>
                                                </tr>
                                                <tr>
