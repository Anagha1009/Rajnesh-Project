<%@ Page Title="Admin :: Distance Learning" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="DistanceColleges.aspx.cs" Inherits="admin_DistanceLearning_Colleges" %>
                ...
                <asp:GridView ID="grd_DLearning" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Reviews">
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                            <ItemTemplate>
                                <a href='<%# "Edu-Reviews.aspx?Type=DistanceCollege&TypeID=" + Eval("iID") %>'>
            ...
            <td>
                ...
                <asp:DetailsView ID="dv_DLearning" runat="server" AutoGenerateRows="False" DataKeyNames="iID"
                    ...
                    <Fields>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblCity" runat="server" Text='<%# Bind("strCity") %>'></asp:Label>
                       </ItemTemplate>
                    </asp:TemplateField> --%>
                        ...
                        <asp:TemplateField HeaderText="Website">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtWebsite" runat="server" Text='<%# Bind("strWebsite") %>'></asp:TextBox><%--<asp:RequiredFieldValidator ID="rfvWebsite" runat="server" ControlToValidate="txtWebsite" Display="Dynamic" ErrorMessage="Website" SetFocusOnError="True">*</asp:RequiredFieldValidator>--%>
                            </EditItemTemplate>
                            <InsertItemTemplate>
                                <asp:TextBox ID="txtWebsite" runat="server" Text='<%# Bind("strWebsite") %>'></asp:TextBox><%--<asp:RequiredFieldValidator ID="rfvWebsite" runat="server" ControlToValidate="txtWebsite" Display="Dynamic" ErrorMessage="Website" SetFocusOnError="True">*</asp:RequiredFieldValidator>--%>
                            </InsertItemTemplate>
                        ...
                        <%--<asp:TemplateField HeaderText="Contact&nbsp;Info" HeaderStyle-VerticalAlign="Top">
                        <EditItemTemplate>
                          <FCKeditorV2:FCKeditor id="FCKContactInfo" BasePath="~/FCKeditor/" Value='<%# Bind("strContactInfo") %>' Height="400" runat="server" Width="550"/> 
                        </EditItemTemplate>
                        <InsertItemTemplate>
                           <FCKeditorV2:FCKeditor id="FCKContactInfo" BasePath="~/FCKeditor/" Value='<%# Bind("strContactInfo") %>' Height="400" runat="server" Width="550"/> 
                        </InsertItemTemplate>
                        <ItemTemplate>
                            <asp:Literal ID="lblContactInfo" runat="server" Text='<%# Bind("strContactInfo") %>'></asp:Literal>
                       </ItemTemplate>
                    </asp:TemplateField>  --%>
