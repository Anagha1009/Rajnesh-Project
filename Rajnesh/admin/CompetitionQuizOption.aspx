<%@ Page Title="Control Panel | CompetitionQuizOption" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="CompetitionQuizOption.aspx.cs" Inherits="admin_CompetitionQuizOption"
                ...
                <asp:GridView ID="grd_Records" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Photo">
                            ...
                            <ItemTemplate>
                                <img src='<%# "../files/CompetitionQuizOption/" + Eval("strLogo") %>' alt="" class="photo" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Answer">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="btnAnswer" CommandName="Answer" CommandArgument='<%# Eval("iID") %>'
                                    CausesValidation="false" />
                                <asp:HiddenField runat="server" ID="hfAnswer" Value='<%# Eval("bAnswer") %>' />
                            </ItemTemplate>
                                            ...
                                            <table width="100%" cellpadding="0px" cellspacing="0px" border="0px">
                                                <tr>
                                                    <td align="left" valign="top" class="_photo_box">
                                                        <img src='<%# VirtualPathUtility.ToAbsolute("~/files/CompetitionQuizOption/" + Eval("strLogo"))%>'
                                                            alt="" />
                                                    </td>
                                                </tr>
                                                <tr>
