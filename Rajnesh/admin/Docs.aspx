<%@ Page Title="Control Panel | Doc" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="Docs.aspx.cs" Inherits="admin_Doc" MaintainScrollPositionOnPostback="true"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Link">
                            ...
                            <div style="width:570px">
                                <div style="padding-top:3px; width:25px; float:left"><a href='<%# "http://www.eduvidya.com/files/Docs/" + Eval("strFile")%>' target="_blank">
                                    <img src="images/Browse.png" alt="browse"/></a></div>
                                <asp:TextBox ID="txtFile" runat="server" Text='<%# "http://www.eduvidya.com/files/Docs/" + Eval("strFile")%>'
                                    CssClass="link_box" onclick="this.focus();this.select()"></asp:TextBox>
                                    </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                                            ...
                                            <table width="100%" cellpadding="0px" cellspacing="0px" border="0px">
                                                <tr>
                                                    <td align="left" valign="top" class="_photo_box">
                                                        <%# "http://www.eduvidya.com/files/Docs" + Eval("strFile")%>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left" valign="top">
                                                        <asp:FileUpload ID="fu_File" runat="server" />
                                                        <asp:HiddenField ID="hf_File" runat="server" Value='<%# Eval("strFile") %>' />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
