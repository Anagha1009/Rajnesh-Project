...
public partial class admin_LevelofStudy : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            BredCrumbs.InnerHtml = "<a class='link' href='" + VirtualPathUtility.ToAbsolute("~/admin/") + "'>Home</a> &nbsp; > &nbsp; &nbsp;LevelofStudy";
    ...
    protected void fn_BindRecords()
    {
        try
        {
			...
			CoreWebList<LevelofStudyClass> objLevelofStudyList = objLevelofStudy.fn_getLevelofStudyList();
			if (objLevelofStudyList.Count > 0)
			{
				ViewState["dtRecords"] = (DataTable)objLevelofStudyList;
				grd_Records.DataSource = objLevelofStudyList;
			}
			else
			{
    ...
    protected void fn_BindDetails(int iRecordID)
    {
        ...
        {
            LevelofStudyClass objLevelofStudy = new LevelofStudyClass();
			objLevelofStudy.iID = iRecordID;
			CoreWebList<LevelofStudyClass> objLevelofStudyList = objLevelofStudy.fn_getLevelofStudyByID();
			if (objLevelofStudyList.Count > 0)
			{
				dv_Records.DataSource = objLevelofStudyList;
				dv_Records.DataBind();
			}
        }
        catch (Exception ex)
    ...
    protected void grd_Records_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        {
            LevelofStudyClass objLevelofStudy = new LevelofStudyClass();
			objLevelofStudy.iID = int.Parse(grd_Records.DataKeys[e.RowIndex].Value.ToString());

			string strResponse = objLevelofStudy.fn_deleteLevelofStudy();
    ...
    protected void dv_Records_ItemInserting(object sender, DetailsViewInsertEventArgs e)
    {
        try
        {
			...
			LevelofStudyClass objLevelofStudy = new LevelofStudyClass();
			objLevelofStudy.strTitle = txtTitle.Text;

			string strResponse = objLevelofStudy.fn_saveLevelofStudy();
    ...
    protected void dv_Records_ItemUpdating(object sender, DetailsViewUpdateEventArgs e)
    {
        try
        {
			...
			LevelofStudyClass objLevelofStudy = new LevelofStudyClass();
			objLevelofStudy.iID = int.Parse(dv_Records.DataKey.Value.ToString());
			objLevelofStudy.strTitle = txtTitle.Text;

			string strResponse = objLevelofStudy.fn_editLevelofStudy();
    ...
    protected void btnSearch_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            LevelofStudyClass objLevelofStudy = new LevelofStudyClass();
			objLevelofStudy.strTitle = txtSearch.Text.Trim();
			CoreWebList<LevelofStudyClass> objLevelofStudyList = objLevelofStudy.fn_getLevelofStudyByKeys();
			if (objLevelofStudyList.Count > 0)
			{
				ViewState["dtRecords"] = (DataTable)objLevelofStudyList;
				grd_Records.DataSource = objLevelofStudyList;
