<%@ Page Title="Admin :: ExamResults" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="ExamResults.aspx.cs" Inherits="admin_ExamResults" MaintainScrollPositionOnPostback="true"
...
<asp:Content ID="Content1" ContentPlaceHolderID="AdminContentPlaceHolder" runat="Server">
    ...
    <table width="95%" border="0" align="center">
        ...
        <tr>
            <td align="center" colspan="3">
                <asp:GridView ID="grd_ExamResults" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    OnRowDeleting="grd_ExamResults_RowDeleting" OnSelectedIndexChanged="grd_ExamResults_SelectedIndexChanged"
                    OnSorting="grd_ExamResults_Sorting" OnPageIndexChanging="grd_ExamResults_PageIndexChanging"
                    PageSize="10">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="strExamResultTitle" HeaderText="ExamResults" SortExpression="strExamResultTitle">
    ...
    <table width="95%" align="center">
        <tr>
            <td class="_heading">
                <asp:Label ID="Label1" CssClass="font_title_text" runat="server" Text="ExamResults Details"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <br />
                <asp:DetailsView ID="dv_ExamResults" runat="server" AutoGenerateRows="False" DataKeyNames="iID"
                    Width="95%" GridLines="None" CellPadding="3" CellSpacing="3" OnItemInserting="dv_ExamResults_ItemInserting"
                    OnItemUpdating="dv_ExamResults_ItemUpdating" OnModeChanging="dv_ExamResults_ModeChanging">
                    <Fields>
                        <asp:BoundField DataField="iID" HeaderText="ID" Visible="False" ReadOnly="True" />
                        
                        <asp:TemplateField HeaderText="Title">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtTitle" runat="server" Text='<%# Eval("strExamResultTitle") %>' CssClass="txtBox">
                                </asp:TextBox>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblTitle" runat="server" Text='<%# Eval("strExamResultTitle") %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Description" HeaderStyle-VerticalAlign="Top">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtDescription" runat="server" CssClass="ckeditor" TextMode="MultiLine"
                                    Text='<%# Eval("strExamResultDesc") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <InsertItemTemplate>
                                <asp:TextBox ID="txtDescription" runat="server" CssClass="ckeditor" TextMode="MultiLine"
                                    Text='<%# Eval("strExamResultDesc") %>'></asp:TextBox>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblDesc" runat="server" Text='<%# Eval("strExamResultDesc") %>'></asp:Label>
                            </ItemTemplate>
