<%@ Page Title="Control Panel | Course" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="Courses.aspx.cs" Inherits="admin_Course" MaintainScrollPositionOnPostback="true"
                            ...
                            <InsertItemTemplate>
                                <table width="100%" cellpadding="3px" cellspacing="3px" border="0px">
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:DropDownList ID="ddlModeofStudy" runat="server" CssClass="ddlBox">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:DropDownList ID="ddlLevelofStudy" runat="server" CssClass="ddlBox">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtFees" runat="server" CssClass="txtbox"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left" class="subTitle">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtEligibility" runat="server" TextMode="MultiLine" CssClass="ckeditor"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left" class="subTitle">
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtAdmissionCriteria" runat="server" TextMode="MultiLine" CssClass="ckeditor"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </InsertItemTemplate>
                            <EditItemTemplate>
                                <table width="100%" cellpadding="3px" cellspacing="3px" border="0px">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtFees" runat="server" CssClass="txtbox" Text='<%# Eval("strFees") %>'></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left" class="subTitle">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtEligibility" runat="server" TextMode="MultiLine" CssClass="ckeditor"
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtAdmissionCriteria" runat="server" TextMode="MultiLine" CssClass="ckeditor"
                                                Text='<%# Eval("strAdmissionCriteria") %>'></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </EditItemTemplate>
