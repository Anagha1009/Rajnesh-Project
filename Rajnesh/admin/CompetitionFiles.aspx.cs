...
public partial class admin_CompetitionFiles : System.Web.UI.Page
{
    ...
    protected void fn_BindRecords()
    {
        try
        {
            ...
            CoreWebList<CompetitionUserClass> objCompetitionEntryList = objCompetitionEntry.fn_getCompetitionFileUserByCompetitionID();
    ...
    protected void btnSearch_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            CoreWebList<CompetitionUserClass> objCompetitionEntryList = objCompetitionEntry.fn_getCompetitionFileUserByKeys();
            if (objCompetitionEntryList.Count > 0)
            {
                ViewState["dtRecords"] = (DataTable)objCompetitionEntryList;
                grd_Records.DataSource = objCompetitionEntryList;
