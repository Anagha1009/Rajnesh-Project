<%@ Page Language="C#" MasterPageFile="~/admin/Master.master" AutoEventWireup="true"
    CodeFile="City.aspx.cs" Inherits="Admin_Machine" Title="Admin :: City Master" %>
            ...
            <tr>
                <td align="center">
                    <asp:GridView ID="grdCityList" runat="server" CssClass="GridViewStyle" Width="100%"
                        ...
                        AlternatingRowStyle-BackColor="#F7F7F7" DataKeyNames="iID" PageSize="10" OnRowDeleting="grdCityList_RowDeleting"
