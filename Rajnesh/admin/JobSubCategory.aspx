<%@ Page Title="Admin :: Job Company" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="JobSubCategory.aspx.cs" Inherits="admin_Articles" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="AdminContentPlaceHolder" runat="Server">
    ...
    <table width="90%" border="0" align="center">
        <tr>
            <td align="left" colspan="3">
                <asp:Label ID="Label3" CssClass="font_title_text" runat="server" Text="J O B &nbsp;&nbsp;&nbsp;S U B&nbsp;&nbsp;&nbsp;C A T E G O R Y&nbsp;&nbsp;&nbsp;&nbsp;L I S T"></asp:Label>
                <br />
                <hr />
            </td>
        </tr>
            ...
            <td align="center" colspan="3">
                <asp:GridView ID="grdCategory" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="strJobSubCategoryName" HeaderText="Title" SortExpression="strArticleTitle">
    ...
    <table width="90%" align="center">
        <tr>
            <td>
                <asp:Label ID="Label1" CssClass="font_title_text" runat="server" Text="J O B &nbsp;&nbsp;&nbsp;S U B&nbsp;&nbsp;&nbsp;C A T E G O R Y&nbsp;&nbsp;&nbsp;&nbsp;L I S T"></asp:Label>
                <br />
                <hr />
                <br />
                ...
                <asp:DetailsView ID="dvCategory" runat="server" AutoGenerateRows="False" DataKeyNames="iID"
                    ...
                    <Fields>
                        ...
                        <asp:TemplateField HeaderText="Title">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtTitle" runat="server" Text='<%# Bind("strJobSubCategoryName") %>'>
                                </asp:TextBox>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblTitle" runat="server" Text='<%# Bind("strJobSubCategoryName") %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Description" HeaderStyle-VerticalAlign="Top">
                            <EditItemTemplate>
                                <FCKeditorV2:FCKeditor ID="fckDesc" runat="server" BasePath="~/FCKeditor/" Height="400px"
                                    Width="600px" Value='<%# Eval("strJobSubCategoryDesc") %>'>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblSubCategoryDesc" runat="server" Text='<%# Bind("strJobSubCategoryDesc") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
