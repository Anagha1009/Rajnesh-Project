...
public partial class admin_EduReview : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            BredCrumbs.InnerHtml = "<a class='link' href='" + VirtualPathUtility.ToAbsolute("~/admin/") + "'>Home</a> &nbsp; > &nbsp; &nbsp;EduReviews";
    ...
    protected void fn_BindRecords()
    {
        try
        {
            ...
            CoreWebList<EduReviewClass> objEduReviewList = objEduReview.fn_getEduReviewList();
            if (objEduReviewList.Count > 0)
            {
                ViewState["dtRecords"] = (DataTable)objEduReviewList;
    ...
    protected void btnSearch_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            CoreWebList<EduReviewClass> objEduReviewList = objEduReview.fn_getEduReviewByKeys();
            if (objEduReviewList.Count > 0)
            {
                ViewState["dtRecords"] = (DataTable)objEduReviewList;
                grd_Records.DataSource = objEduReviewList;
    ...
    protected string fn_GetInstitutionName(string strInstitutionType, int InstitutionID)
    {
        try
        {
            string strInstitute = "";
