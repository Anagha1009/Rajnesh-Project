<%@ Page Title="Admin :: Control Panel" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="AdminCity.aspx.cs" Inherits="admin_ControlPanel"
...
<asp:Content ID="Content1" ContentPlaceHolderID="AdminContentPlaceHolder" runat="Server">
                ...
                <asp:GridView ID="grd_Records" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Small Image">
                            ...
                            <ItemTemplate>
                                <img src='<%# "Upload/City_photos/" + Eval("strPhoto") %>' class="photo" />
                            </ItemTemplate>
                        </asp:TemplateField>
    ...
    <table width="95%" align="center">
        <tr>
            <td class="_heading">
                <asp:Label ID="Label1" CssClass="font_title_text" runat="server" Text="City Details"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                                ...
                                <table width="100%" cellpadding="0px" cellspacing="0px" border="0px">
                                    <tr>
                                        <td width="50px" align="left" valign="top" style="padding-top: 15px">
                                            <asp:Image ID="img_Photo" runat="server" ImageUrl='<%# "Upload/City_photos/" + Eval("strPhoto") %>'
