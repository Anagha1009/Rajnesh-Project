<%@ Page Title="Admin :: Testpapers" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="Testpapers.aspx.cs" Inherits="admin_Testpapers" MaintainScrollPositionOnPostback="true"
...
<asp:Content ID="Content1" ContentPlaceHolderID="AdminContentPlaceHolder" runat="Server">
    ...
    <table width="95%" border="0" align="center">
        ...
        <tr>
            <td align="center" colspan="3">
                <asp:GridView ID="grd_Testpapers" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    OnRowDeleting="grd_Testpapers_RowDeleting" OnSelectedIndexChanged="grd_Testpapers_SelectedIndexChanged"
                    OnSorting="grd_Testpapers_Sorting" OnPageIndexChanging="grd_Testpapers_PageIndexChanging"
                    PageSize="10">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="strTestpaperTitle" HeaderText="Testpapers" SortExpression="strTestpaperTitle">
    ...
    <table width="95%" align="center">
        <tr>
            <td class="_heading">
                <asp:Label ID="Label1" CssClass="font_title_text" runat="server" Text="Testpapers Details"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <br />
                <asp:DetailsView ID="dv_Testpapers" runat="server" AutoGenerateRows="False" DataKeyNames="iID"
                    Width="95%" GridLines="None" CellPadding="3" CellSpacing="3" OnItemInserting="dv_Testpapers_ItemInserting"
                    OnItemUpdating="dv_Testpapers_ItemUpdating" OnModeChanging="dv_Testpapers_ModeChanging">
                    <Fields>
                        <asp:BoundField DataField="iID" HeaderText="ID" Visible="False" ReadOnly="True" />
                        
                        <asp:TemplateField HeaderText="Title">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtTitle" runat="server" Text='<%# Eval("strTestpaperTitle") %>' CssClass="txtBox">
                                </asp:TextBox>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblTitle" runat="server" Text='<%# Eval("strTestpaperTitle") %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Description" HeaderStyle-VerticalAlign="Top">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtDescription" runat="server" CssClass="ckeditor" TextMode="MultiLine"
                                    Text='<%# Eval("strTestpaperDesc") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <InsertItemTemplate>
                                <asp:TextBox ID="txtDescription" runat="server" CssClass="ckeditor" TextMode="MultiLine"
                                    Text='<%# Eval("strTestpaperDesc") %>'></asp:TextBox>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lblDesc" runat="server" Text='<%# Eval("strTestpaperDesc") %>'></asp:Label>
                            </ItemTemplate>
