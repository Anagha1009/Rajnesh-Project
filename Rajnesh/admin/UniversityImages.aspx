<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Master.master" AutoEventWireup="true" CodeFile="UniversityImages.aspx.cs" Inherits="admin_UniversityImages" %>
...
<table width="90%" align="center">
    <tr>
        <td align="left">
          <asp:Label id="Label3" CssClass="font_title_text" runat="server" Text="U N I V E R S I T Y&nbsp;&nbsp;&nbsp;&nbsp;I M A G E S&nbsp;&nbsp;&nbsp;&nbsp;L I S T"></asp:Label>
            <br />
            <hr />
        </td>
    </tr>
              ...
              DataKeyNames="iID" PageSize="10" 
                ...
                <Columns>
                   ...
                   <asp:TemplateField HeaderText="Image" SortExpression="iID">
                            ...
                            ImageUrl='<%#"~/admin/RelatedImages/Universities/" +Eval("strThumbnail")%>' ></asp:Image>
                            </ItemTemplate>
...
<table width="90%" align="center">   
    <tr>
        <td>
           <asp:Label id="Label1" CssClass="font_title_text" runat="server" Text="U N I V E R S I T Y&nbsp;&nbsp;&nbsp;&nbsp;I M A G E&nbsp;&nbsp;&nbsp;&nbsp;D E T A I L S"></asp:Label>
            <br />
            <hr />
            <br />
               ...
               <Fields>
                   ...
                   <asp:TemplateField HeaderText="Title">
                    ...
                    <asp:TemplateField HeaderStyle-VerticalAlign="Top" HeaderText="Thumbnail">
                        <EditItemTemplate>
                            <asp:Image id ="imgThumbnail" ImageUrl='<%#"~/admin/RelatedImages/Universities/" +Eval("strThumbnail")%>' ToolTip='<%# Bind("strThumbnail") %>' runat="server" Width="100px" Height="80px" />
                        ...
                        <ItemTemplate>                        
                             <asp:Image id ="imgThumbnail" ImageUrl='<%#"~/admin/RelatedImages/Universities/" +Eval("strThumbnail")%>' runat="server" Width="100px" Height="80px" />
                             <asp:HiddenField runat="server" ID="hfId" Value='<%# Eval("iID") %>' />
                     ...
                     <asp:TemplateField HeaderText="Upload&nbsp;Image" >  
                            <InsertItemTemplate>
                                <asp:FileUpload ID="fuThumbnailImage" runat="server" CssClass="btn_input"/>
                        ...
                        <EditItemTemplate>
                            <asp:Image id ="imgBigImage" ImageUrl='<%#"~/admin/RelatedImages/Universities/" +Eval("strBigImage")%>' ToolTip='<%# Bind("strBigImage") %>' runat="server" Width="100px" Height="80px" />
                        ...
                        <ItemTemplate>                        
                             <asp:Image id ="imgBigImage" ImageUrl='<%#"~/admin/RelatedImages/Universities/" +Eval("strBigImage")%>' runat="server" Width="100px" Height="80px" />
                             <asp:HiddenField runat="server" ID="hfId" Value='<%# Eval("iID") %>' />
                            <asp:Label runat="server" ID="lblImageName"></asp:Label>
                       </ItemTemplate>
                    </asp:TemplateField>   
                     ...
                     <asp:TemplateField HeaderText="Upload&nbsp;Image" >  
                            <InsertItemTemplate>
                                <asp:FileUpload ID="fuBigImage" runat="server" CssClass="btn_input"/>
