...
public partial class admin_DistanceLearningImages : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
                if (Request.QueryString["DLID"] != null)
                {
                    ...
                    objImc.strType = "DistanceLearning";
                    objImc.iTypeID = int.Parse(Request.QueryString["DLID"].ToString());
    ...
    protected void dv_Images_ItemInserting(object sender, DetailsViewInsertEventArgs e)
    {
        try
        {
            ...
            if (fuThumbnailImage.HasFile)
            {
                ...
                strDocPath = Server.MapPath("~/admin/RelatedImages/DistanceLearning/" + strRanFileName);
            ...
            if (fuBigImage.HasFile)
            {
                ...
                strDocPath1 = Server.MapPath("~/admin/RelatedImages/DistanceLearning/" + strRanFileName1);
