<%@ Page Title="Control Panel | FactorHeading" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="FactorHeading.aspx.cs" Inherits="admin_FactorHeading"
                ...
                <asp:GridView ID="grd_Records" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Icon">
                            ...
                            <ItemTemplate>
                                <img src='<%# "../files/Icons/" + Eval("strIcon") %>' alt="" class="photo" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Factor">
                            <ItemStyle HorizontalAlign="Center" Width="10%" />
                            <ItemTemplate>
                                <a href='<%# "Factor.aspx?HeadingID=" + Eval("iID") %>'>
                                                ...
                                                <table width="100%" cellpadding="0px" cellspacing="0px" border="0px">
                                                    <tr>
                                                        <td align="left" valign="top" class="_photo_box">
                                                            <img src='<%# VirtualPathUtility.ToAbsolute("~/files/Icons/" + Eval("strIcon"))%>'
                                                                alt="" />
                                                        </td>
                                                    </tr>
                                                    <tr>
