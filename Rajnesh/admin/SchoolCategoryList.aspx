<%@ Page Language="C#" MasterPageFile="~/admin/Master.master" AutoEventWireup="true"
    CodeFile="SchoolCategoryList.aspx.cs" Inherits="admin_ControlPanel" Title="Admin :: Control Panel" %>
    ...
    <table width="80%" align="center">
        <tr>
            <td colspan="3" style="height: 67px">
                <asp:Label ID="Label1" ForeColor="#ff6633" runat="server" Font-Bold="true" Text="School Name : "></asp:Label>
                <asp:Label ID="lbl_Title" ForeColor="#ff6633" runat="server" Font-Bold="true"></asp:Label><br />
                <br />
                <asp:Label ID="Label2" CssClass="font_title_text" runat="server" Text="School Category List"></asp:Label>
                <br />
                <hr />
                <br />
            </td>
        ...
        <tr>
            ...
            <td align="left">
                <asp:ListBox runat="server" ID="ListBox_Category" Font-Size="Small" Width="550px"
