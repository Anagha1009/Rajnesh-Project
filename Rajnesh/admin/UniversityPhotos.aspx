<%@ Page Title="Control Panel | UniversityPhoto" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="UniversityPhotos.aspx.cs" Inherits="admin_UniversityPhoto" MaintainScrollPositionOnPostback="true"
                ...
                <asp:GridView ID="grd_Records" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    <Columns>
						...
						<asp:TemplateField HeaderText="Photo">
							...
							<ItemTemplate>
								<img src='<%# "../files/UniversityPhoto/" + Eval("strPhoto") %>' alt="" class="photo" />
							</ItemTemplate>
						</asp:TemplateField>
											...
											<table width="100%" cellpadding="0px" cellspacing="0px" border="0px">
												<tr>
													<td align="left" valign="top" class="_photo_box">
														<img src='<%# VirtualPathUtility.ToAbsolute("~/files/UniversityPhoto/" + Eval("strPhoto"))%>' alt="" />
													</td>
												</tr>
												<tr>
													<td align="left" valign="top">
