<%@ Page Title="Control Panel | ExamTimeTable" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="ExamTimeTable.aspx.cs" Inherits="admin_ExamTimeTable" MaintainScrollPositionOnPostback="true"
                            ...
                            <EditItemTemplate>
                                <table width="100%" cellpadding="3px" cellspacing="3px" border="0px">
									...
									<tr>
										...
										<td align="left">
											<asp:textbox ID="txtDesc" runat="server" TextMode="MultiLine" CssClass="ckeditor" Text='<%# Eval("strDesc") %>'></asp:textbox>
										</td>
									</tr>
