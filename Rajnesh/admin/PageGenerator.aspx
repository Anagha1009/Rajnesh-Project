<%@ Page Title="Control Panel | PageGenerator" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="PageGenerator.aspx.cs" Inherits="admin_PageGenerator" MaintainScrollPositionOnPostback="true"
                ...
                <asp:GridView ID="grd_Records" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    <Columns>
						...
						<asp:TemplateField HeaderText="Photo">
							...
							<ItemTemplate>
								<img src='<%# "../files/PageGenerator/" + Eval("strPhoto") %>' alt="" class="photo" />
							</ItemTemplate>
						</asp:TemplateField>
						...
						<asp:TemplateField HeaderText="PagePhoto">
						<ItemStyle HorizontalAlign="Center" Width="10%" />
						<ItemTemplate>
							<a href='<%# "PagePhoto.aspx?PageID=" + Eval("iID") %>'><img src="images/add.png" alt="" class="Icons"/></a>
						</ItemTemplate>
						</asp:TemplateField>
                            ...
                            <InsertItemTemplate>
                                <table width="100%" cellpadding="3px" cellspacing="3px" border="0px">
									...
									<tr>
										...
										<td align="left">
											<asp:textbox ID="txtMetaTitle" runat="server" TextMode="MultiLine" CssClass="txtArea"></asp:textbox>
										</td>
									</tr>
									...
									<tr>
										...
										<td align="left">
											<asp:textbox ID="txtMetaDesc" runat="server" TextMode="MultiLine" CssClass="txtArea"></asp:textbox>
										</td>
									</tr>
									...
									<tr>
										...
										<td align="left">
											<asp:textbox ID="txtMetaKeys" runat="server" TextMode="MultiLine" CssClass="txtArea"></asp:textbox>
										</td>
									</tr>
                            ...
                            <EditItemTemplate>
                                <table width="100%" cellpadding="3px" cellspacing="3px" border="0px">
									...
									<tr>
										...
										<td align="left">
											<asp:textbox ID="txtMetaTitle" runat="server" TextMode="MultiLine" CssClass="txtArea" Text='<%# Eval("strMetaTitle") %>'></asp:textbox>
										</td>
									</tr>
									...
									<tr>
										...
										<td align="left">
											<asp:textbox ID="txtMetaDesc" runat="server" TextMode="MultiLine" CssClass="txtArea" Text='<%# Eval("strMetaDesc") %>'></asp:textbox>
										</td>
									</tr>
									...
									<tr>
										...
										<td align="left">
											<asp:textbox ID="txtMetaKeys" runat="server" TextMode="MultiLine" CssClass="txtArea" Text='<%# Eval("strMetaKeys") %>'></asp:textbox>
										</td>
									</tr>
											...
											<table width="100%" cellpadding="0px" cellspacing="0px" border="0px">
												<tr>
													<td align="left" valign="top" class="_photo_box">
														<img src='<%# VirtualPathUtility.ToAbsolute("~/files/PageGenerator/" + Eval("strPhoto"))%>' alt="" />
													</td>
												</tr>
												<tr>
													<td align="left" valign="top">
