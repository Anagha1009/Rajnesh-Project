<%@ Page Title="Control Panel | Page" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="Page.aspx.cs" Inherits="admin_Page" MaintainScrollPositionOnPostback="true"
                ...
                <asp:GridView ID="grd_Records" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Box">
                            ...
                            <ItemTemplate>
                                <a href='<%# "Box.aspx?PageID=" + Eval("iID") %>'>
