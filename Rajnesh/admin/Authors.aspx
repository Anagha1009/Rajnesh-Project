<%@ Page Title="Control Panel | Author" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="Authors.aspx.cs" Inherits="admin_Author" MaintainScrollPositionOnPostback="true"
                ...
                <asp:GridView ID="grd_Records" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    <Columns>
						...
						<asp:TemplateField HeaderText="Photo">
							...
							<ItemTemplate>
								<img src='<%# "../files/Author/" + Eval("strPhoto") %>' alt="" class="photo" />
							</ItemTemplate>
						</asp:TemplateField>
                            ...
                            <InsertItemTemplate>
                                <table width="100%" cellpadding="3px" cellspacing="3px" border="0px">
									...
									<tr>
										...
										<td align="left">
											<asp:textbox ID="txtConnectUrl" runat="server" CssClass="txtBox"></asp:textbox>
										</td>
									</tr>
                            ...
                            <EditItemTemplate>
                                <table width="100%" cellpadding="3px" cellspacing="3px" border="0px">
									...
									<tr>
										...
										<td align="left">
											<asp:textbox ID="txtConnectUrl" runat="server" CssClass="txtBox" Text='<%# Eval("strConnectUrl") %>'></asp:textbox>
										</td>
									</tr>
											...
											<table width="100%" cellpadding="0px" cellspacing="0px" border="0px">
												<tr>
													<td align="left" valign="top" class="_photo_box">
														<img src='<%# VirtualPathUtility.ToAbsolute("~/files/Author/" + Eval("strPhoto"))%>' alt="" />
													</td>
												</tr>
												<tr>
													<td align="left" valign="top">
