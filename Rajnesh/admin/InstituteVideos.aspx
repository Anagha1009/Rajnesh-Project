<%@ Page Title="Admin :: Institute Videos" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="InstituteVideos.aspx.cs" Inherits="admin_Videos" MaintainScrollPositionOnPostback="true"
...
<asp:Content ID="Content1" ContentPlaceHolderID="AdminContentPlaceHolder" runat="Server">
    ...
    <table width="95%" align="center">
        <tr>
            <td class="_heading">
                <asp:Label ID="Label1" CssClass="font_title_text" runat="server" Text="Institute Video Details"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
