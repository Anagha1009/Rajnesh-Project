<%@ Page Title="Control Panel | Blogs" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="Blogs.aspx.cs" Inherits="admin_Blogs" MaintainScrollPositionOnPostback="true"
                ...
                <asp:GridView ID="grd_Records" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Photo">
                            ...
                            <ItemTemplate>
                                <img src='<%# "../files/Blog/" + Eval("strImage") %>' alt="" class="photo" />
                            </ItemTemplate>
                        </asp:TemplateField>
                            ...
                            <InsertItemTemplate>
                                <table width="100%" cellpadding="3px" cellspacing="3px" border="0px">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" CssClass="ckeditor"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left" class="subTitle">
                            ...
                            <EditItemTemplate>
                                <table width="100%" cellpadding="3px" cellspacing="3px" border="0px">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" CssClass="ckeditor"
                                                Text='<%# Eval("strDescription") %>'></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table width="100%" cellpadding="0px" cellspacing="0px" border="0px">
                                                <tr>
                                                    <td align="left" valign="top" class="_photo_box">
                                                        <img src='<%# VirtualPathUtility.ToAbsolute("~/files/Blog/" + Eval("strImage"))%>'
                                                            alt="" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left" valign="top">
                                                        <asp:FileUpload ID="fu_Image" runat="server" />
                                                        <asp:HiddenField ID="hf_Image" runat="server" Value='<%# Eval("strImage") %>' />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
