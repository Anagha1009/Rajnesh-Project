<%@ Page Title="Control Panel | BannerDetail" Language="C#" MasterPageFile="~/admin/Master.master"
    AutoEventWireup="true" CodeFile="BannerDetail.aspx.cs" Inherits="admin_BannerDetail" MaintainScrollPositionOnPostback="true"
                ...
                <asp:GridView ID="grd_Records" runat="server" Width="100%" GridLines="None" AllowPaging="True"
                    ...
                    <Columns>
						...
						<asp:TemplateField HeaderText="Photo">
							...
							<ItemTemplate>
								<img src='<%# "../files/BannerDetail/" + Eval("strPhoto") %>' alt="" class="photo" />
							</ItemTemplate>
						</asp:TemplateField>
                            ...
                            <InsertItemTemplate>
                                <table width="100%" cellpadding="3px" cellspacing="3px" border="0px">
									...
									<tr>
										...
										<td align="left">
											<asp:textbox ID="txtLink" runat="server" CssClass="txtbox"></asp:textbox>
										</td>
									</tr>
                            ...
                            <EditItemTemplate>
                                <table width="100%" cellpadding="3px" cellspacing="3px" border="0px">
									...
									<tr>
										...
										<td align="left">
											<asp:textbox ID="txtOrder" runat="server" CssClass="txtbox" Text='<%# Eval("iOrder") %>'></asp:textbox>
										</td>
									</tr>
									...
									<tr>
										...
										<td align="left">
											<asp:textbox ID="txtLink" runat="server" CssClass="txtbox" Text='<%# Eval("strLink") %>'></asp:textbox>
										</td>
									</tr>
											...
											<table width="100%" cellpadding="0px" cellspacing="0px" border="0px">
												<tr>
													<td align="left" valign="top" class="_photo_box">
														<img src='<%# VirtualPathUtility.ToAbsolute("~/files/BannerDetail/" + Eval("strPhoto"))%>' alt="" />
													</td>
												</tr>
												<tr>
													<td align="left" valign="top">
