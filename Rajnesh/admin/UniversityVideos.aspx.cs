...
public partial class admin_UniversityVideo : System.Web.UI.Page
{
    ...
    protected void fn_BindRecords()
    {
        try
        {
            UniversityVideosClass objUniversityVideo = new UniversityVideosClass();
			objUniversityVideo.iUniversityID = iUniversityID;
			CoreWebList<UniversityVideosClass> objUniversityVideoList = objUniversityVideo.fn_getUniversityVideoByUniversityID();
    ...
    protected void fn_BindDetails(int iRecordID)
    {
        try
        {
			...
			CoreWebList<UniversityVideosClass> objUniversityVideoList = objUniversityVideo.fn_getUniversityVideoByID();
			if (objUniversityVideoList.Count > 0)
			{
    ...
    protected void btnSearch_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
			...
			CoreWebList<UniversityVideosClass> objUniversityVideoList = objUniversityVideo.fn_getUniversityVideoByKeys();
			if (objUniversityVideoList.Count > 0)
			{
				ViewState["dtRecords"] = (DataTable)objUniversityVideoList;
				grd_Records.DataSource = objUniversityVideoList;
