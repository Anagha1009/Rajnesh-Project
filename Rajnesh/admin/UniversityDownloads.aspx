<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Master.master" AutoEventWireup="true" CodeFile="UniversityDownloads.aspx.cs" Inherits="admin_UniversityDownloads" %>
...
<table width="90%" align="center">
    <tr>
        <td align="left">
          <asp:Label id="Label3" CssClass="font_title_text" runat="server" Text="U N I V E R S I T Y&nbsp;&nbsp;&nbsp;&nbsp;D O W N L O A D S&nbsp;&nbsp;&nbsp;&nbsp;L I S T"></asp:Label>
            <br />
            <hr />
        </td>
    </tr>
...
<table width="90%" align="center">   
    <tr>
        <td>
           <asp:Label id="Label1" CssClass="font_title_text" runat="server" Text="U N I V E R S I T Y&nbsp;&nbsp;&nbsp;&nbsp;D O W N L O A D S&nbsp;&nbsp;&nbsp;&nbsp;D E T A I L S"></asp:Label>
            <br />
            <hr />
            <br />
               ...
               <Fields>
                   ...
                   <asp:TemplateField HeaderText="Title">
                     ...
                     <asp:TemplateField HeaderText="Upload&nbsp;File" >  
                            <InsertItemTemplate>
                                <asp:FileUpload ID="fuFile" runat="server" CssClass="btn_input"/>
