...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Best Schools in India 2021 List, Top Ranking CBSE, ICSE, IB schools</title>
    <meta name="Description" content="Get List of Best Schools in India 2021 with Ranking. Also find CBSE, ICSE, IB and IGCSE Schools in India" />
    <meta name="Keywords" content="Schools in India" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cp_left" runat="Server">
    <div class="box">
        <div class="heading"><a href="#">Best Schools in India 2021</a></div>
