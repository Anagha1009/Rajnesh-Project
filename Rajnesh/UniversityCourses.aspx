<%@ Page Language="C#" MasterPageFile="~/ClientMaster.master" AutoEventWireup="true"
    CodeFile="UniversityCourses.aspx.cs" Inherits="CollegeCourses" %>
            ...
            <div class="filter-result">
                ...
                <ul>
                    <asp:Repeater ID="rpt_Courses" runat="server">
                        <ItemTemplate>
                            <li><a href='<%# VirtualPathUtility.ToAbsolute("~/University/" + RouteData.Values["University"].ToString() + "/Courses/" + Eval("strCourseName").ToString().Replace(" ","-").Replace(".","_"))%>'>
                                <%# Eval("strCourseName")%></a>
                                <br />
                                <%# ((bool)(Eval("strCourseDetails").ToString().Length > 210)) == true ? Eval("strCourseDetails").ToString().Replace("<p>", "").Replace("</p>", "").Substring(0, 210) + " ..." : Eval("strCourseDetails")%>
                                <li>
                        </ItemTemplate>
                    </asp:Repeater>
                </ul>
