...
jQuery(document).ready(function(){
	...
	jQuery('#contactslider_box input#wname').each(function(i){
		jQuery(this).focus(function(){
	...
	}); //Contact slider_box Name
	
	jQuery('#contactslider_box input#wemail').each(function(i){
		jQuery(this).focus(function(){
	...
	}); //Contact slider_box Email
	
	jQuery('#contactslider_box textarea#wmessage').each(function(i){
		jQuery(this).focus(function(){
...
/* Flickr Lightbox */
jQuery(document).ready(function() {
	jQuery('#flickr .flickr_badge_image a, .cmsmasters_flickr_slider_box .flickr_badge_image a').each(function(i){
...
jQuery(document).ready(function(){ 
	jQuery('#contactslider_box a#wformsend').click(function(){ 
		...
		jQuery('#contactslider_box .loading').animate({opacity: 1}, 250);
		
		if ($name != '' && $nameshort != true && $namelong != true && $email != '' && $emailerror != false && $message != '' && $messageshort != true && $contactemail != '' && $contacturl != '' && $mywebsite != ''){ 
			jQuery.post($contacturl, 
				{type: 'slider_box', contactemail: $contactemail, name: $name, email: $email, message: $message, mywebsite: $mywebsite}, 
				function(data){
					jQuery('#contactslider_box .loading').animate({opacity: 0}, 250);
					jQuery('.form').fadeOut();
					jQuery('#bottom #wname, #bottom #wemail, #bottom #wmessage').css({'border-bottom':'0'});
					jQuery('.slider_boxerror').hide();
					jQuery('.slider_boxinfo').fadeIn('slow');
					jQuery('.slider_boxinfo').delay(5000).fadeOut(1000, function(){ 
			...
			jQuery('#contactslider_box .loading').animate({opacity: 0}, 250);
			jQuery('.slider_boxerror').hide();
			jQuery('.slider_boxerror').fadeIn('fast');
			jQuery('.slider_boxerror').delay(5000).fadeOut(1000);
...
if (jQuery.browser.msie && jQuery.browser.version < 9){
	jQuery(document).ready(function(){
		jQuery('.slider_box_custom_comments_entries li:last-child').css('background','none'); //Comments slider_box
		jQuery('.slider_box_custom_popular_entries li:last-child').css('background','none'); //Popular Posts slider_box
		jQuery('.slider_box_custom_popular_news_entries li:last-child').css('background','none'); //Popular News slider_box
		...
		jQuery('.slider_box_links li:last-child').css('border','none'); //slider_box Links
	});
};
